export const DEFAULT_METADATA = {
  ...
  subtitle: "Implementation & Web Application Integration",
...
export const DEFAULT_MARKDOWN = `# Public Key Infrastructure (PKI) - Implementation & Web Application Integration
