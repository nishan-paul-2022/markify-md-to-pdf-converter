...
**Nodes LIST:**
![Nodes Output](./images/task1-nodes.png)

**Topology Links Check (Net):**
![Net Output](./images/task1-net.png)

**Node Details Check (Dump):**
![Dump Output](./images/task1-dump.png)
...
| Packets Received | 3 |
| Packet Loss | 0% |
| Minimum RTT | 0.064 ms |
| Average RTT | 0.837 ms |
| Maximum RTT | 2.334 ms |
| Standard Deviation | 1.058 ms |
...
|-----------|------------|---------------|----------|
| h1 → h4 (Client) | 37.1 Gbits/sec | 43.2 GBytes | 10 sec |
| h4 → h1 (Server) | 37.1 Gbits/sec | 43.2 GBytes | 10 sec |
...
**Screenshot:**  
![Verify Ping](./images/task5-verify.png)
...
**Screenshot:**  
![Restore Ping](./images/task5-restore.png)
...
```mermaid
graph TB
    subgraph SegmentA["Segment A - Reachable"]
    H1[h1]
    H2[h2]
    S1[s1]
    S2[s2]
    ...
    subgraph SegmentB["Segment B - Isolated"]
    H3[h3]
    H4[h4]
    S3[s3]
    S4[s4]
